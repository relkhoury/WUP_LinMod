...
```
Model 3 reduced the residual standard error of model 1 by 29.45, indicating it is a more apt model compared to model 1.  P-value shows this is difference is statistically significant.
